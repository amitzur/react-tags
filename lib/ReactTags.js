...
class ReactTags extends Component {
  ...
  handleFocus(e) {
    ...
    const suggestions = this.filteredSuggestions(this.state.query, this.props.suggestions);

    this.setState({ isFocused: true, suggestions });
  }
...
ReactTags.PropTypes = {
  ...
  predefinedSuggestions: PropTypes.array,

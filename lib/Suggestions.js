...
class Suggestions extends Component {
  ...
  shouldComponentUpdate = nextProps => {
    ...
    return (
      ...
      shouldRenderSuggestions(nextProps.query, nextProps.showPredefined) ||
      shouldRenderSuggestions(nextProps.query, nextProps.showPredefined) !=
        shouldRenderSuggestions(props.query, props.showPredefined)
    );
  };
  ...
  shouldRenderSuggestions = (query, showPredefined) => {
    const { props } = this;
    const minQueryLength = typeof props.minQueryLength === 'number' ? props.minQueryLength : 2;
